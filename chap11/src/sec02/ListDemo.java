...
//		animals2.add("늑대");
		...
		String[] animals3 = animals2.toArray(new String[0]); // toArray:다시 배열로 바꿀거야~
		for (int i = 0; i < animals3.length; i++)
			System.out.print(animals3[i] + " ");
		System.out.println();

		List<String> carList = List.of("그랜저", "소나타", "아반테", "제네시스");
//		car.set(1, "싼타페");
		carList.forEach(s -> System.out.print(s + " ")); // 향상된 포문과 같은 역할
